...
module "couchbase_data_nodes_target_group" {
  ...
  vpc_id            = "${data.aws_vpc.default.id}"
  http_listener_arn = "${module.load_balancer.http_listener_arns[var.data_nodes_load_balancer_port]}"
...
module "couchbase_index_query_search_nodes_target_group" {
  ...
  health_check_path = "/ui/index.html"
  vpc_id            = "${data.aws_vpc.default.id}"
  http_listener_arn = "${module.load_balancer.http_listener_arns[var.index_query_search_nodes_load_balancer_port]}"
